...
namespace WestBank.Services.Tests
{
    [TestFixture]
    public class PaymentsServiceTests
    {
        ...
        public void Process_Should_Return_Decline_When_Invalid_Card_Details_Provided()
        {
            ...
            var sut = new PaymentsService(_mockDbContext.Object, _mockPaymentCardValidator.Object, null);
        ...
        public void Process_Should_Return_Success_When_All_Details_Correct()
        {
            ...
            var sut = new PaymentsService(_mockDbContext.Object, _mockPaymentCardValidator.Object, rules);
        ...
        public void GetDetails_Should_Return_PaymentDetails()
        {
            ...
            var sut = new PaymentsService(dbContext, _mockPaymentCardValidator.Object, null);
